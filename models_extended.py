...
使用 define_models(db) 工厂函数，在 app.py 中 db 初始化后调用
"""
...
def define_models(db):
    ...
    class City(db.Model):
        ...
        __table_args__ = (
            db.Index('idx_city_province', 'province_name'),
    ...
    class Food(db.Model):
        ...
        __table_args__ = (
            db.Index('idx_food_city', 'city'),
            db.Index('idx_food_province', 'province'),
            db.Index('idx_food_category', 'category'),
        )
    ...
    class TripPlan(db.Model):
        ...
        __table_args__ = (
            db.Index('idx_trip_city', 'city'),
            db.Index('idx_trip_days', 'days'),
        )
    ...
    class Review(db.Model):
        ...
        __table_args__ = (
            db.Index('idx_review_dest', 'destination_id'),
            db.Index('idx_review_user', 'user_id'),
            db.Index('idx_review_status', 'status'),
        )
